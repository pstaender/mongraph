...
module.exports = exports = mongraphMongoosePlugin = function(schema, options) {
  var schemaOptions, _base, _base1, _base2, _base3, _base4, _base5, _base6, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
  ...
  if ((_ref5 = (_base4 = schemaOptions.graphability).relationships) == null) {
    _base4.relationships = {};
  }
  if ((_ref6 = (_base5 = schemaOptions.graphability.relationships).removeAllOutgoing) == null) {
    _base5.removeAllOutgoing = true;
  }
  if ((_ref7 = (_base6 = schemaOptions.graphability.relationships).removeAllIncoming) == null) {
    _base6.removeAllIncoming = true;
  }
