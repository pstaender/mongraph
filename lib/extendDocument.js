...
module.exports = function(mongoose, graphdb, globalOptions) {
  ...
  Document.prototype.findCorrespondingNode = function(options, cb) {
    var collectionName, doc, id, _processNode, _ref, _ref1, _ref2;

    _ref = processtools.sortOptionsAndCallback(options, cb), options = _ref.options, cb = _ref.cb;
    doc = this;
    collectionName = doc.constructor.collection.name;
    id = processtools.getObjectIDAsString(doc);
    if ((_ref1 = options.doCreateIfNotExists) == null) {
      options.doCreateIfNotExists = false;
    }
    if ((_ref2 = options.forceCreation) == null) {
  ...
  Document.prototype.removeNode = function(options, cb) {
    ...
    _ref = processtools.sortOptionsAndCallback(options, cb), options = _ref.options, cb = _ref.cb;
    if ((_ref1 = options.includeRelationships) == null) {
