...
module.exports = function(globalOptions) {
  ...
  Document.prototype.queryRelationships = function(typeOfRelationship, options, cb) {
    var doc, id, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
    ...
    if ((_ref5 = options.returnStatement) == null) {
      options.returnStatement = options.processPart;
    }
    if ((_ref6 = options.referenceDocumentID) == null) {
      options.referenceDocumentID = this._id;
    }
    if ((_ref7 = options.endNodeId) == null) {
      options.endNodeId = '';
    }
    ...
    return this.getNode(function(nodeErr, fromNode) {
      var cypher, _ref10, _ref11, _ref12, _ref13, _ref8, _ref9;
      ...
      cypher = _s.sprintf(cypher, {
        ...
        whereRelationship: ((_ref8 = options.where) != null ? _ref8.relationship : void 0) ? "WHERE " + options.where.relationship : '',
        endNodeId: options.endNodeId ? ", b = node(" + options.endNodeId + ")" : ''
      });
      if ((_ref9 = options.startNode) == null) {
        options.startNode = fromNode.id;
      }
      if (options.cypher) {
        cypher = options.cypher;
      }
      if ((_ref10 = options.debug) != null) {
        if ((_ref11 = _ref10.cypher) == null) {
          _ref10.cypher = [];
        }
      }
  ...
  Document.prototype.dataForNode = function(options) {
    var definition, flattenSeperator, index, indexes, path, paths, self, values, _ref1, _ref2, _ref3;
    ...
    for (path in paths) {
      ...
      if (index) {
        if (((_ref1 = definition.options) != null ? _ref1.graph : void 0) === true && ((_ref2 = definition.options) != null ? _ref2.index : void 0) === true) {
          indexes.push(path.split('.').join(flattenSeperator));
        }
      } else if (((_ref3 = definition.options) != null ? _ref3.graph : void 0) === true) {
        if (typeof self.get(path) !== 'undefined') {
  ...
  Document.prototype.indexInGraph = function(options, cb) {
    var collectionName, doc, index, join, pathToIndex, value, _j, _len1, _ref1;
