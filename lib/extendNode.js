...
module.exports = function(globalOptions) {
  var Node, functionName, graphdb, mongoose, node, _i, _len, _loadDocumentFromNode, _loadDocumentFromNodeUrl, _ref;
  ...
  Node.prototype.getCollectionName = function() {
    ...
    return ((_ref1 = this._data) != null ? (_ref2 = _ref1.indexed) != null ? (_ref3 = _ref2.match(/\/data\/index\/node\/(.+?)\//)) != null ? _ref3[1] : void 0 : void 0 : void 0) || ((_ref4 = this._data) != null ? _ref4.data._collection : void 0);
  };
