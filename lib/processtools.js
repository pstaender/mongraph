...
var Join, ObjectId, constructorNameOf, extendPath, extendRelationship, extractCollectionAndId, getCollectionByCollectionName, getModelByCollectionName, getModelNameByCollectionName, getMongoose, getNeo4j, getObjectIDAsString, getObjectIDsAsArray, getObjectIdFromString, mongoose, neo4j, populateResultWithDocuments, setMongoose, setNeo4j, sortAttributesAndCallback, sortJoins, sortOptionsAndCallback, sortTypeOfRelationshipAndOptionsAndCallback, _buildQueryFromIdAndCondition;
...
getModelNameByCollectionName = function(collectionName, mongooseHandler) {
  var _ref;

  if (mongooseHandler == null) {
    mongooseHandler = mongoose;
  }
  return (_ref = getModelByCollectionName(collectionName, mongooseHandler)) != null ? _ref.modelName : void 0;
};
...
populateResultWithDocuments = function(results, options, cb) {
  ...
  _fn = function(result, i) {
    ...
    if (constructorNameOf(result) === 'Node' && ((_ref11 = result.data) != null ? _ref11._collection : void 0) && ((_ref12 = result.data) != null ? _ref12._id : void 0)) {
      callback = join.add();
