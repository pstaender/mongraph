...
var Join, ObjectId, constructorNameOf, getCollectionByCollectionName, getModelByCollectionName, getMongoose, getNeo4j, getObjectIDAsString, getObjectIDsAsArray, getObjectIdFromString, mongoose, neo4j, populateResultWithDocuments, setMongoose, setNeo4j, sortJoins, sortOptionsAndCallback, _buildQueryFromIdAndCondition, _extractCollectionAndId;
  ...
  _fn = function(result, i) {
    ...
    if (constructorNameOf(result) === 'Node' && ((_ref8 = result.data) != null ? _ref8.collection : void 0) && ((_ref9 = result.data) != null ? _ref9._id : void 0)) {
      ...
      _fn1 = function(point, intermediateCallback) {
        ...
        _ref13 = _extractCollectionAndId(result.data["_" + point]), collectionName = _ref13.collectionName, _id = _ref13._id;
