...
module.exports = exports = mongraphMongoosePlugin = function(schema, options) {
  ...
  schema.pre('remove', function(errHandler) {
    ...
    return doc.getNode(function(err, node) {
      return node["delete"](function() {
        return 'node will be delete, if removeAllOutgoing and removeAllIncoming is set to true';
  ...
  return schema.pre('save', function(next) {
    ...
    return doc.findOrCreateEquivalentNode(function(err, node) {
      if (node) {
