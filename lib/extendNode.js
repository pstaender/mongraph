...
module.exports = function(graphdb, mongoose, options) {
  ...
  _loadDocumentFromNode = function(node, cb) {
    var collection, collectionName, _id, _ref, _ref1, _ref2;
    ...
    collection = mongoose.models[(_ref1 = options.collectionToModel) != null ? _ref1[collectionName] : void 0] || ((_ref2 = mongoose.connections[0]) != null ? _ref2.collection(collectionName) : void 0) || mongoose.collection(collectionName);
