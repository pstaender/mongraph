...
populateResultWithDocuments = function(results, options, cb) {
  var final, graphdb, i, join, path, result, _fn, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
  ...
  if ((_ref7 = options.debug) != null) {
    if ((_ref8 = _ref7.where) == null) {
      _ref7.where = [];
    }
  }
  if ((_ref9 = options.stripEmptyItems) == null) {
  ...
  _fn = function(result, i) {
    var callback, collection, conditions, fromAndToJoin, intermediateCallback, isReferenceDocument, k, node, point, _fn1, _j, _k, _len1, _len2, _p, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _results;

    if (constructorNameOf(result) === 'Node' && ((_ref10 = result.data) != null ? _ref10.collection : void 0) && ((_ref11 = result.data) != null ? _ref11._id : void 0)) {
      callback = join.add();
    ...
    } else if (constructorNameOf(result) === 'Relationship' && ((_ref13 = result.data) != null ? _ref13._from : void 0) && ((_ref14 = result.data) != null ? _ref14._to : void 0)) {
      callback = join.add();
      fromAndToJoin = Join.create();
      _ref15 = ['from', 'to'];
      _fn1 = function(point, intermediateCallback) {
        var collectionName, _id, _ref16, _ref17, _ref18;

        _ref16 = extractCollectionAndId(result.data["_" + point]), collectionName = _ref16.collectionName, _id = _ref16._id;
        ...
        if (options.collection && options.collection !== collectionName && !isReferenceDocument) {
          ...
          if ((_ref17 = options.debug) != null) {
            if ((_ref18 = _ref17.where) != null) {
              _ref18.push(conditions);
            }
          }
      ...
      _ref16 = _p._nodes;
      _results = [];
      for (k = _k = 0, _len2 = _ref16.length; _k < _len2; k = ++_k) {
        node = _ref16[k];
        if ((_ref17 = node._data) != null ? _ref17.self : void 0) {
          callback = join.add();
          _results.push((function(k, callback) {
            return graphdb.getNode(node._data.self, function(err, foundNode) {
              var collectionName, _id, _ref18, _ref19, _ref20;

              if (foundNode != null ? (_ref18 = foundNode.data) != null ? _ref18._id : void 0 : void 0) {
                ...
                if (options.collection && options.collection !== collectionName && !isReferenceDocument) {
                  ...
                  if ((_ref19 = options.debug) != null) {
                    if ((_ref20 = _ref19.where) != null) {
                      _ref20.push(conditions);
                    }
                  }
                  collection = getCollectionByCollectionName(collectionName, mongoose);
                  return collection.findOne(conditions, function(err, foundDocument) {
  ...
  return join.when(function() {
    ...
    _ref10 = sortJoins(arguments), error = _ref10.error, result = _ref10.result;
