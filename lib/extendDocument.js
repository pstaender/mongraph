...
module.exports = function(mongoose, graphdb, globalOptions) {
  ...
  Document.prototype.getNode = Document.prototype.findOrCreateEquivalentNode;
  ...
  Document.prototype.queryRelationships = function(kindOfRelationship, options, cb) {
    var doc, id, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _s;
  ...
  Document.prototype.removeRelationships = function(kindOfRelationship, cb, direction) {
    if (direction == null) {
      direction = 'both';
    }
    return this.queryRelationships(kindOfRelationship, {
  ...
  return Document.prototype.shortestPathTo = function(doc, kindOfRelationship, cb) {
    var from, to;
    ...
    return from.getNode(function(errFrom, fromNode) {
      return to.getNode(function(errTo, toNode) {
        ...
        return from.queryGraph(query, cb);
      });
    });
  };
};
