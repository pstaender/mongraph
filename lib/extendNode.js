...
module.exports = function(graphdb, mongoose, options) {
  ...
  _loadDocumentFromNode = function(node, cb) {
    var collection, collectionName, modelName, _id, _ref, _ref1;
    ...
    collection = mongoose.models[modelName] || ((_ref1 = mongoose.connections[0]) != null ? _ref1.collection(collectionName) : void 0) || mongoose.collection(collectionName);
